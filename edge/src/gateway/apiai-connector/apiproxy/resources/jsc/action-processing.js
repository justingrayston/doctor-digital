...
if(action === "patient"){
    // get patient info
    path+="Patient?phone="+body.result.parameters['phone-number'];
...
if(action === "clinic.confirm"){
    ...
    path+="Location?organization="+organization;
    serviceCalloutFlag = true;
    verb = "GET";
...
if(action === "appointment.get" || action === "appointment.book" || action === "appointment.del" ){
